...
interface ChangeEntry { category: ChangeCategory; description: string; }
interface VersionInfo { version: string; date: string; summary: string; changes: ChangeEntry[]; }
export const CHANGELOG_VERSIONS: VersionInfo[] = [
  { version: '0.1.0', date: '2026-08-20', summary: '首个版本迭代:代码编辑器工作区、GitHub Releases 更新、品牌重塑与 CI 加固', changes: [/* 按四类提炼 */] },
];
```
