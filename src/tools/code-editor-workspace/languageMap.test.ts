  ...
  it('covers all major hot languages', () => {
    ...
    expect(ids).toEqual(
      expect.arrayContaining([
        'rust', 'go', 'python', 'java', 'c', 'cpp', 'csharp',
        'php', 'swift', 'kotlin', 'dart', 'ruby', 'lua', 'r',
        'perl', 'scala', 'objective-c', 'powershell', 'dockerfile',
        'graphql', 'hcl', 'bat', 'fsharp', 'julia', 'proto',
        'pascal', 'vb', 'clojure', 'elixir',
      ]),
    );
  });
});
