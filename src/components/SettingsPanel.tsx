...
const LICENSES: LicenseEntry[] = [
  ...
  { name: 'Monaco Editor', license: 'MIT License', homepage: 'https://microsoft.github.io/monaco-editor' },
  ...
  { name: 'SQL Formatter', license: 'MIT License', homepage: 'https://github.com/sql-formatter-org/sql-formatter' },
  ...
  { name: 'window-vibrancy', license: 'MIT License', homepage: 'https://github.com/tauri-apps/window-vibrancy' },
];
...
const COMPONENTS: OpenSourceComponent[] = [
  // ---------- 前端 npm 依赖 ----------
  { name: 'react', version: '^19.2.8', source: 'frontend', description: '用于构建用户界面的声明式库', license: 'MIT', repository: 'https://github.com/facebook/react', homepage: 'https://react.dev' },
  { name: 'react-dom', version: '^19.2.8', source: 'frontend', description: 'React 的 DOM 渲染器', license: 'MIT', repository: 'https://github.com/facebook/react' },
  { name: 'react-router-dom', version: '^7.18.2', source: 'frontend', description: 'React 官方声明式路由库', license: 'MIT', repository: 'https://github.com/remix-run/react-router', homepage: 'https://reactrouter.com' },
  { name: '@tauri-apps/api', version: '^2.11.1', source: 'frontend', description: 'Tauri 2.0 JavaScript API', license: 'Apache-2.0 / MIT', repository: 'https://github.com/tauri-apps/tauri', homepage: 'https://tauri.app' },
  { name: '@tauri-apps/plugin-updater', version: '^2.10.1', source: 'frontend', description: 'Tauri 应用更新插件', license: 'Apache-2.0 / MIT', repository: 'https://github.com/tauri-apps/plugins-workspace' },
  { name: '@tauri-apps/plugin-dialog', version: '^2.7.2', source: 'frontend', description: 'Tauri 原生对话框插件', license: 'Apache-2.0 / MIT', repository: 'https://github.com/tauri-apps/plugins-workspace' },
  { name: '@tauri-apps/plugin-shell', version: '^2.3.5', source: 'frontend', description: 'Tauri Shell 调用插件', license: 'Apache-2.0 / MIT', repository: 'https://github.com/tauri-apps/plugins-workspace' },
  { name: '@tauri-apps/plugin-clipboard-manager', version: '^2.3.2', source: 'frontend', description: 'Tauri 剪贴板管理插件', license: 'Apache-2.0 / MIT', repository: 'https://github.com/tauri-apps/plugins-workspace' },
  { name: 'zustand', version: '^5.0.14', source: 'frontend', description: '轻量级状态管理库', license: 'MIT', repository: 'https://github.com/pmndrs/zustand' },
  { name: 'react-hook-form', version: '^7.83.0', source: 'frontend', description: '高性能表单状态管理', license: 'MIT', repository: 'https://github.com/react-hook-form/react-hook-form', homepage: 'https://react-hook-form.com' },
  { name: '@hookform/resolvers', version: '^5.5.7', source: 'frontend', description: 'React Hook Form 校验解析器', license: 'MIT', repository: 'https://github.com/react-hook-form/resolvers' },
  { name: 'zod', version: '^4.4.3', source: 'frontend', description: '运行时类型校验库', license: 'MIT', repository: 'https://github.com/colinhacks/zod', homepage: 'https://zod.dev' },
  { name: 'tailwindcss', version: '^4.3.3', source: 'frontend', description: '原子化 CSS 框架 v4', license: 'MIT', repository: 'https://github.com/tailwindlabs/tailwindcss', homepage: 'https://tailwindcss.com' },
  { name: '@radix-ui/primitives', version: '^1.1.21', source: 'frontend', description: '无头 UI 组件原语(Dialog / Tabs / Select 等)', license: 'MIT', repository: 'https://github.com/radix-ui/primitives', homepage: 'https://www.radix-ui.com' },
  { name: 'shadcn/ui', version: '—', source: 'frontend', description: '基于 Radix + Tailwind 的可复用组件集合', license: 'MIT', repository: 'https://github.com/shadcn-ui/ui', homepage: 'https://ui.shadcn.com' },
  { name: 'lucide-react', version: '^1.28.0', source: 'frontend', description: 'Lucide 图标库的 React 封装', license: 'ISC', repository: 'https://github.com/lucide-icons/lucide', homepage: 'https://lucide.dev' },
  { name: 'monaco-editor', version: '^0.56.0', source: 'frontend', description: 'VS Code 同款代码编辑器', license: 'MIT', repository: 'https://github.com/microsoft/monaco-editor', homepage: 'https://microsoft.github.io/monaco-editor' },
  { name: '@monaco-editor/react', version: '^4.7.0', source: 'frontend', description: 'Monaco 编辑器的 React 封装', license: 'MIT', repository: 'https://github.com/suren-atoyan/monaco-react' },
  { name: 'sonner', version: '^2.0.7', source: 'frontend', description: 'Toast 通知组件', license: 'MIT', repository: 'https://github.com/emilkowalski/sonner', homepage: 'https://sonner.emilkowal.ski' },
  { name: 'cmdk', version: '^1.1.1', source: 'frontend', description: '命令面板组件', license: 'MIT', repository: 'https://github.com/pacocoursey/cmdk' },
  { name: 'class-variance-authority', version: '^0.7.1', source: 'frontend', description: '类型安全的 className 变体管理', license: 'Apache-2.0', repository: 'https://github.com/joe-bell/cva' },
  { name: 'clsx', version: '^2.1.1', source: 'frontend', description: '条件 className 构造工具', license: 'MIT', repository: 'https://github.com/lukeed/clsx' },
  { name: 'tailwind-merge', version: '^3.6.0', source: 'frontend', description: '智能合并 Tailwind 类名', license: 'MIT', repository: 'https://github.com/dcastil/tailwind-merge' },
  { name: 'sql-formatter', version: '^15.8.2', source: 'frontend', description: 'SQL 语句格式化', license: 'MIT', repository: 'https://github.com/sql-formatter-org/sql-formatter' },
  { name: 'date-fns', version: '^4.4.0', source: 'frontend', description: '现代日期工具库', license: 'MIT', repository: 'https://github.com/date-fns/date-fns', homepage: 'https://date-fns.org' },
  { name: 'react-resizable-panels', version: '^4.12.2', source: 'frontend', description: '可调整大小的面板', license: 'MIT', repository: 'https://github.com/bvaughn/react-resizable-panels' },
  { name: '@tanstack/react-virtual', version: '^3.14.9', source: 'frontend', description: '虚拟列表渲染', license: 'MIT', repository: 'https://github.com/TanStack/virtual', homepage: 'https://tanstack.com/virtual' },
  { name: 'yaml', version: '^2.9.0', source: 'frontend', description: 'YAML 解析与序列化', license: 'ISC', repository: 'https://github.com/eemeli/yaml' },
  { name: 'vite', version: '^8.1.5', source: 'frontend', description: '下一代前端构建工具', license: 'MIT', repository: 'https://github.com/vitejs/vite', homepage: 'https://vitejs.dev' },
  { name: 'typescript', version: '^6.0.3', source: 'frontend', description: 'JavaScript 的超集，添加静态类型', license: 'Apache-2.0', repository: 'https://github.com/microsoft/TypeScript', homepage: 'https://www.typescriptlang.org' },
  { name: 'vitest', version: '^4.1.10', source: 'frontend', description: '单元测试框架', license: 'MIT', repository: 'https://github.com/vitest-dev/vitest', homepage: 'https://vitest.dev' },

  // ---------- Rust crates 依赖 ----------
  { name: 'tauri', version: '2', source: 'rust', description: '构建跨平台桌面应用的 Rust 框架', license: 'Apache-2.0 / MIT', repository: 'https://github.com/tauri-apps/tauri', homepage: 'https://tauri.app' },
  { name: 'tauri-plugin-updater', version: '2', source: 'rust', description: '应用自动更新插件', license: 'Apache-2.0 / MIT', repository: 'https://github.com/tauri-apps/plugins-workspace' },
  { name: 'tauri-plugin-dialog', version: '2', source: 'rust', description: '原生对话框插件', license: 'Apache-2.0 / MIT', repository: 'https://github.com/tauri-apps/plugins-workspace' },
  { name: 'tauri-plugin-shell', version: '2', source: 'rust', description: 'Shell 命令调用插件', license: 'Apache-2.0 / MIT', repository: 'https://github.com/tauri-apps/plugins-workspace' },
  { name: 'tauri-plugin-clipboard-manager', version: '2', source: 'rust', description: '剪贴板访问插件', license: 'Apache-2.0 / MIT', repository: 'https://github.com/tauri-apps/plugins-workspace' },
  { name: 'tauri-plugin-window-state', version: '2', source: 'rust', description: '窗口状态记忆插件', license: 'Apache-2.0 / MIT', repository: 'https://github.com/tauri-apps/plugins-workspace' },
  { name: 'tauri-plugin-single-instance', version: '2', source: 'rust', description: '单实例运行插件', license: 'Apache-2.0 / MIT', repository: 'https://github.com/tauri-apps/plugins-workspace' },
  { name: 'tokio', version: '1.40', source: 'rust', description: '异步运行时与并发工具库', license: 'MIT', repository: 'https://github.com/tokio-rs/tokio', homepage: 'https://tokio.rs' },
  { name: 'serde', version: '1', source: 'rust', description: '序列化/反序列化框架', license: 'MIT / Apache-2.0', repository: 'https://github.com/serde-rs/serde', homepage: 'https://serde.rs' },
  { name: 'serde_json', version: '1', source: 'rust', description: 'JSON 序列化实现', license: 'MIT / Apache-2.0', repository: 'https://github.com/serde-rs/json' },
  { name: 'thiserror', version: '1', source: 'rust', description: '派生错误类型的库', license: 'MIT / Apache-2.0', repository: 'https://github.com/dtolnay/thiserror' },
  { name: 'anyhow', version: '1', source: 'rust', description: '灵活的错误处理库', license: 'MIT / Apache-2.0', repository: 'https://github.com/dtolnay/anyhow' },
  { name: 'uuid', version: '1', source: 'rust', description: 'UUID 生成与解析', license: 'MIT / Apache-2.0', repository: 'https://github.com/uuid-rs/uuid' },
  { name: 'futures', version: '0.3', source: 'rust', description: '异步编程抽象库', license: 'MIT / Apache-2.0', repository: 'https://github.com/rust-lang/futures-rs' },
  { name: 'async-trait', version: '0.1', source: 'rust', description: '异步 trait 方法支持', license: 'MIT / Apache-2.0', repository: 'https://github.com/dtolnay/async-trait' },
  { name: 'tokio-util', version: '0.7', source: 'rust', description: 'Tokio 工具集', license: 'MIT', repository: 'https://github.com/tokio-rs/tokio' },
  { name: 'chrono', version: '0.4', source: 'rust', description: '日期时间库', license: 'MIT / Apache-2.0', repository: 'https://github.com/chronotope/chrono' },
  { name: 'chrono-tz', version: '0.9', source: 'rust', description: '时区数据', license: 'MIT / Apache-2.0', repository: 'https://github.com/chronotope/chrono-tz' },
  { name: 'regex', version: '1', source: 'rust', description: '正则表达式库', license: 'MIT / Apache-2.0', repository: 'https://github.com/rust-lang/regex' },
  { name: 'sha2', version: '0.10', source: 'rust', description: 'SHA-2 哈希算法实现', license: 'MIT / Apache-2.0', repository: 'https://github.com/RustCrypto/hashes' },
  { name: 'sha3', version: '0.10', source: 'rust', description: 'SHA-3 哈希算法实现', license: 'MIT / Apache-2.0', repository: 'https://github.com/RustCrypto/hashes' },
  { name: 'blake3', version: '1.5', source: 'rust', description: 'BLAKE3 哈希算法实现', license: 'CC0-1.0 / Apache-2.0', repository: 'https://github.com/BLAKE3-team/BLAKE3' },
  { name: 'md-5', version: '0.10', source: 'rust', description: 'MD5 哈希算法实现', license: 'MIT / Apache-2.0', repository: 'https://github.com/RustCrypto/hashes' },
  { name: 'jsonwebtoken', version: '9', source: 'rust', description: 'JWT 编解码库', license: 'MIT', repository: 'https://github.com/Keats/jsonwebtoken' },
  { name: 'base64', version: '0.22', source: 'rust', description: 'Base64 编码解码', license: 'MIT / Apache-2.0', repository: 'https://github.com/marshallpierce/rust-base64' },
  { name: 'url', version: '2.5', source: 'rust', description: 'URL 解析库', license: 'MIT / Apache-2.0', repository: 'https://github.com/servo/rust-url' },
  { name: 'percent-encoding', version: '2.3', source: 'rust', description: 'URL 百分号编码', license: 'MIT / Apache-2.0', repository: 'https://github.com/servo/rust-url' },
  { name: 'window-vibrancy', version: '0.8', source: 'rust', description: 'Windows 云母 / macOS 亚克力窗口材质', license: 'MIT', repository: 'https://github.com/tauri-apps/window-vibrancy' },
  { name: 'windows', version: '0.61', source: 'rust', description: 'Windows API 绑定（DirectWrite 字体枚举等）', license: 'MIT / Apache-2.0', repository: 'https://github.com/microsoft/windows-rs' },
  { name: 'directories', version: '5.0', source: 'rust', description: '系统数据目录查询', license: 'MIT / Apache-2.0', repository: 'https://github.com/dirs-dev/directories-rs' },
  { name: 'parking_lot', version: '0.12', source: 'rust', description: '高性能同步原语', license: 'MIT / Apache-2.0', repository: 'https://github.com/Amanieu/parking_lot' },
  { name: 'tracing', version: '0.1', source: 'rust', description: '结构化日志库', license: 'MIT', repository: 'https://github.com/tokio-rs/tracing' },
];
