  ...
  json_formatter: [
    {
      ...
      title: T_INPUT,
      description: {
        zh: 'JSON / YAML / TOML / XML 等七种格式输入,自动转 JSON;含格式化、修复、错误定位操作',
        en: 'JSON / YAML / TOML / XML and more input formats auto-converted to JSON, with format, repair and error-location actions',
      },
      keywords: [
        'json',
        'xml',
...
export const SETTING_FIELDS: readonly SettingField[] = [
  ...
  // 文本编辑器
  {
    ...
    description: {
      ...
      en: 'Bracket colors / sticky scroll / guides / wrap / minimap / size / indent',
    },
    keywords: [
      '括号',
      '着色',
  ...
  {
    key: 'new_file',
    title: { zh: '新建文件', en: 'New file' },
    description: { zh: 'Ctrl+N', en: 'Ctrl+N' },
    keywords: ['新建', '文件'],
    menuId: 'shortcuts',
  },
  {
    key: 'open_file',
    title: { zh: '打开文件', en: 'Open file' },
    description: { zh: 'Ctrl+O', en: 'Ctrl+O' },
    keywords: ['打开', '文件'],
    menuId: 'shortcuts',
  },
  {
    key: 'save_all',
    title: { zh: '全部保存', en: 'Save all' },
    description: { zh: 'Ctrl+Shift+S', en: 'Ctrl+Shift+S' },
    keywords: ['保存', '全部'],
    menuId: 'shortcuts',
  },
  {
    key: 'close_editor',
    title: { zh: '关闭编辑器', en: 'Close editor' },
    description: { zh: 'Ctrl+W', en: 'Ctrl+W' },
    keywords: ['关闭', '编辑器'],
    menuId: 'shortcuts',
  },
  {
    key: 'close_all_editors',
    title: { zh: '全部关闭', en: 'Close all editors' },
    description: { zh: 'Ctrl+Shift+W', en: 'Ctrl+Shift+W' },
    keywords: ['关闭', '全部'],
    menuId: 'shortcuts',
  },
  {
    key: 'toggle_editor_sidebar',
    title: { zh: '切换编辑器左栏', en: 'Toggle editor sidebar' },
    description: { zh: 'Ctrl+B', en: 'Ctrl+B' },
    keywords: ['编辑器', '左栏', '侧栏'],
    menuId: 'shortcuts',
  },
  {
    key: 'next_tab',
    title: { zh: '下一个 Tab', en: 'Next tab' },
    description: { zh: 'Ctrl+Tab', en: 'Ctrl+Tab' },
    keywords: ['tab', '切换', '下一个'],
    menuId: 'shortcuts',
  },
  {
    key: 'previous_tab',
    title: { zh: '上一个 Tab', en: 'Previous tab' },
    description: { zh: 'Ctrl+Shift+Tab', en: 'Ctrl+Shift+Tab' },
    keywords: ['tab', '切换', '上一个'],
    menuId: 'shortcuts',
  },
  {
    key: 'reopen_closed_tab',
    title: { zh: '恢复关闭的 Tab', en: 'Reopen closed tab' },
    description: { zh: 'Ctrl+Shift+T', en: 'Ctrl+Shift+T' },
    keywords: ['恢复', '关闭', 'tab', '撤销'],
    menuId: 'shortcuts',
  },
  {
    key: 'diff_prev_change',
    title: { zh: '上一处差异', en: 'Previous change' },
    description: { zh: 'F7', en: 'F7' },
    keywords: ['diff', '差异', '比较', '上一个', '跳转'],
    menuId: 'shortcuts',
  },
  {
    key: 'diff_next_change',
    title: { zh: '下一处差异', en: 'Next change' },
    description: { zh: 'Shift+F7', en: 'Shift+F7' },
