...
| 序号 | 文档 | 核心内容 | 阅读时长 |
|------|------|---------|---------|
| 07 | [工具目录](./07-tool-catalog.md) | 32 个工具清单（P0/P1/P2 分级），10 个 P0 工具的详细规格（输入/输出/错误码/示例） | 25 分钟 |
...
| 16 | [状态管理](./16-state-management.md) | React 状态方案选型（Zustand+React Query）、Rust 侧状态持久化、用户配置读写流程、剪贴板状态机 | 16 分钟 |
