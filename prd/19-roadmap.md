...
| 稳定版 | v1.0 | 启动后 6 个月 | 22+ 工具（P0+P1）+ 完整功能 |
...
**决策理由**：10 个 P0 工具覆盖六大分类中的五个（Comparator 类 Diff 工具推迟到 v1.0）与所有架构特性（流式、文件、依赖、双向转换），既验证架构又提供实用价值。少于 10 个无法覆盖架构特性，多于 10 个交付时间风险高。
